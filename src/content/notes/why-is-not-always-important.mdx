...
imageLink: /
title: "'Why' is not always important"
---

When reflecting, 'Why?' is often the wrong question to ask. Instead, try using "How?" and "What?"

Before I get into this, there are other places where I espouse the importance of 'Why'. Project planning is one such place, briefing a team on work to be done is another. So meet me part way in this communication if you want to get the most out of it. I'm putting forward an idea that, for me, has value. Through effective reinterpretation it could have value for you too.

Okay, so here's a little more context: This line of thought follows on from catching myself deviating from a given plan. When I planned to do one thing but end up doing another, **What** do I do instead? **How** did this happen?
...
## Questions of How can be more useful, they encourage specifics.
