...
- [ ] Write a script that can crop a city scale tile into 25 town scale tiles automagically
  - There's a package called [Jimp](https://www.pnpmjs.com/package/jimp) that does programmatic cropping
...
_It's six months later now 2022-06 and I'd like to iterate on that last statement..._

1. It's advantageous to see an overview in one place.
1. Blogging about how the project is going allows me to get back into it after a break.
1. There's value in the items, especially the in progress ones, being in a work planner too.

The third point feeds into a note I published a few months after originally publishing this one -- [The Overview](/notes/the-overview-enters/) It's about my decision to create an aggregation project in GitHub to for issues across multiple repos in a single view.
