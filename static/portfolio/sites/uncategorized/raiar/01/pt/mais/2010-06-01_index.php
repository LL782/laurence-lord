  ...
  <div class="subsection">
   ...
   <div class="mainContainer02">
    ...
    <form name="contactFormEn" id="contactFormEn" action="contactFormSender.php" onsubmit="return validateContactForm();" method="post">
     ...
     <h5 id="h5Optional1B">
      <a href="#" id="slideinB">Detalhes Opcionais (clique aqui) : </a>
     </h5>
    ...
    <div class="subsectionEnder">
     ...
     <a class="downArrow" href="#links"></a>    </div>
  ...
  <div class="subsection">
   ...
   <div class="mainContainer02">
    ...
    ?>
     ...
     <p><a href="http://raiar.org/01/pt/mais/#links">Por favor clique aqui para atualizar...</a></p>
     <div class="spacer250"></div>
    </div>
    
    <div class="subsectionEnder">
     <a class="upArrow" href="#top"></a>    </div>
   ...
   <div class="sideLinks">
     ...
     <p>Selecione uma lista de links do submenu à direita...</p>
     <div class="spacer250"></div>
    </div>
