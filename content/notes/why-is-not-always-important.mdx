...
I'm trying to catch myself in the act of doing this. I caught this one earlier: I plan to work on a personal project but instead I end up washing the dishes. Interestingly since catching that I don't do it anymore. Further context around this deceptively mundane topic is that I'm doing some work that involves looking at my existing tendencies with a desire to make changes. In actual fact the desire is to get more personal projects done and the approach I'm employing is better neuro lingistic programming. So naturally, seemingly mundane things come up and some prove themselves to be significant complications.
...
I'm thinking this through as I write. I feel like these rabbit holes are examples of complexity that I don't need in the system, and if I can understand **what** the complexity is doing, and **how**, and replace it with something simple, or simply remove it, then there is far more to be gained than from going down the rabbit holes.
