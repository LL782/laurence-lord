...
The third point feeds into an note I published a few months after originally publishing this one -- [The Overview](/notes/the-overview-enters) It's about my decision to create an aggregation project in GitHub to for issues across multiple repos in a single view. 
