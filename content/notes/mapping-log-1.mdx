...
1. There's value in those items, especially the in progress ones, being in my work planner too.

The third point feeds into an note I published a few months after this. The Overview -- it's about my decision to create an aggregation project in GitHub to present issues across multiple repos in a single view. 
