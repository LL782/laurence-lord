...
There are <Link to="/notes/on-creating-digital-maps">some really good links about placing 3D assets on a real scale world map</Link> that I want to turn into a personal learning path. So am I wasting time by not getting straight down to that?
