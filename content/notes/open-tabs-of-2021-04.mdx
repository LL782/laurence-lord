...
There are <Link to="/notes/on-creating-digital-maps">some really good links about placing 3D assets on a world scale map</Link>. I want to turn those into a personal learning path. 

So am I wasting time by not getting straight down to that? I don't think so. There's something restful and restorative about tidying up after the previous engagement, and something pleasing about preparing for the next focus with a tidy working environment.
