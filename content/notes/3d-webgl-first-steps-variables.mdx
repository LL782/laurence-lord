...
We measure how much time passed since the last animation frame and pass that into the **drawScene** function.
...
I'm interested in all of these and now I'm walking through the code I've inherited, looking for the variables that corrispond to these effects.

<EmbedFrame src="/embeds/3d-web-gl-first-steps-variables/zoom-spinning-cube/" />

| Vary                 | Variable               | Notes                                                                                                              |
| :------------------- | :--------------------- | :----------------------------------------------------------------------------------------------------------------- |
| Cube position        | `drawingPositionZ`     | Used in starting drawing position                                                                                  |
| Camera position      | n/a                    | As far as I can tell, this isn't a thing. The camera is constant and undefined, the position of the scene can vary |
| Camera magnification | `fieldOfViewInRadians` | Used in `mat4.perspective`                                                                                         |
| Cube size            | n/a                    | Decided not to explore this here                                                                                   |
