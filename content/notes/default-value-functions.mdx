...
title: "Today I learnt more about how default values in Javascript, Typescript or Node can work"
---

This learning assumes good knowledge of [**Destructuring assignment in Javascript**](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment), Typescript or Node. See these MDN docs linked to here for a foundation in this, particularly [Object destructuring](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment#object_destructuring) and default values.
...
_Credit to [Daniel Bird](https://github.com/Dan-Bird) who just did this naturally while we were pairing, which made me_ <Emoji label="thinking face">🤔</Emoji>
