...
Execute tasks one at a time following `.cursor/skills/incremental-implementation/SKILL.md` (`incremental-implementation`) and `.cursor/skills/test-driven-development/SKILL.md` (`test-driven-development`). Use `.cursor/skills/context-engineering/SKILL.md` (`context-engineering`) to load the right spec sections and source files at each step rather than flooding the agent with the entire spec.
