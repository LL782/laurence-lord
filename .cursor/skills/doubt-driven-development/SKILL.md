...
In Claude Code, the role-based reviewers in `agents/` start with isolated context by design and are usable here — see `.cursor/agents/` for the roster and per-domain match.
